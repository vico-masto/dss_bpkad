    ...
    <div className="max-w-7xl mx-auto space-y-10 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="flex items-center gap-6">
          <div className="w-16 h-16 bg-slate-900 rounded-xl flex items-center justify-center text-white shadow-2xl shadow-slate-900/30">
      ...
      <form onSubmit={(e) => handleSubmit(e)} className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8 space-y-10">
          ...
          <div className="bg-white p-10 rounded-xl shadow-sm border border-slate-100 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-2 h-full bg-slate-100 group-focus-within:bg-ds-primary transition-colors duration-500"></div>
            <div className="flex items-center justify-between mb-10">
              <h3 className="text-lg font-bold text-slate-900 tracking-tight flex items-center">
                <FileText className="mr-3 text-fin-info-text" size={24} />
                Identitas dokumen
              </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
              <div className="space-y-2 group/field">
                <label className="text-[11px] font-bold text-slate-500 ml-1 transition-colors group-focus-within/field:text-fin-info-text">Nomor SP2D</label>
                <input 
                  type="text" 
                  placeholder="0000/SP2D/LS/2026"
                  className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-ds-focus-ring/5 focus:border-ds-focus-ring outline-none transition-all focus:bg-white font-bold text-slate-800 placeholder:text-slate-200"
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2 group/field">
                  ...
                  <input 
                    type="date" 
                    className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-brand/5 focus:border-brand outline-none font-bold text-slate-700"
              ...
              <div className="space-y-2 group/field">
                ...
                <select 
                  className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-brand/5 focus:border-brand outline-none font-black text-slate-700 appearance-none cursor-pointer"
                  value={formData.opd}
              ...
              <div className="md:col-span-2 space-y-2 group/field">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-14 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-brand/5 focus:border-brand outline-none transition-all focus:bg-white font-black text-slate-800 placeholder:text-slate-200"
              ...
              <div className="md:col-span-2 space-y-2 group/field">
                ...
                <textarea 
                  className="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-brand/5 focus:border-brand outline-none min-h-[120px] font-medium text-slate-700"
          ...
          <div className="bg-white p-10 rounded-[48px] shadow-sm border border-slate-100">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
              ...
              <button 
                type="button"
                onClick={addDetail}
                className="flex items-center space-x-2 text-xs bg-brand text-white font-black hover:bg-brand-dark px-6 py-3 rounded-xl transition-all shadow-lg shadow-brand/20 active:scale-95"
              >
                <Plus size={16} />
            ...
            <div className="space-y-6">
              {details.map((detail, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-6 p-8 bg-slate-50/50 rounded-xl border border-slate-100 items-end hover:bg-white hover:shadow-xl hover:shadow-slate-200/50 transition-all group/item">
                  <div className="md:col-span-7 space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Sumber Dana</label>
                    <select 
                      className="w-full px-5 py-4 bg-white border border-slate-200 rounded-xl outline-none focus:ring-4 focus:ring-brand/5 focus:border-brand font-black text-slate-700"
                  ...
                  <div className="md:col-span-4 space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        type="text" 
                        className="w-full pl-14 pr-5 py-4 bg-white border border-slate-200 rounded-xl outline-none focus:ring-4 focus:ring-brand/5 focus:border-brand font-black text-brand text-lg"
                  ...
                  <div className="md:col-span-1 flex justify-center pb-1">
                     <button 
                      ...
                      className="w-12 h-12 flex items-center justify-center text-slate-300 hover:text-white hover:bg-rose-500 rounded-xl transition-all shadow-sm"
        ...
        <div className="lg:col-span-4 space-y-8">
           ...
           <div className="bg-slate-900 p-10 rounded-[48px] shadow-2xl text-white sticky top-10 overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex items-center gap-6 p-6 bg-white/5 rounded-xl border border-white/5 group/val hover:bg-white/10 transition-colors">
                  <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center shadow-inner">
                ...
                <div className="flex items-center gap-6 p-6 bg-white/5 rounded-xl border border-white/5 group/val hover:bg-white/10 transition-colors">
                  <div className="w-14 h-14 rounded-xl bg-rose-500/20 flex items-center justify-center shadow-inner">
                ...
                <div className="pt-10 border-t border-white/5 flex items-center gap-6">
                  <div className="w-16 h-16 rounded-xl bg-brand/20 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-700">
                ...
                <div className="space-y-3 pt-6">
                  ...
                  <div className="relative">
                    ...
                    <label 
                      htmlFor="file-upload"
                      className="w-full flex items-center justify-center p-4 bg-white/5 border border-dashed border-white/10 rounded-xl cursor-pointer hover:bg-white/10 hover:border-brand transition-all text-xs font-bold text-slate-400"
                    >
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full py-5 bg-brand hover:bg-brand-dark text-white rounded-xl font-black shadow-2xl shadow-brand/40 transition-all flex items-center justify-center space-x-3 active:scale-95 disabled:opacity-50 group/btn mt-4 overflow-hidden relative"
                >
      ...
      {talanganPrompt && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-xl p-10 animate-in fade-in zoom-in duration-300">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-full bg-slate-50 rounded-xl p-6 mb-8 text-left space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <button 
                  ...
                  className="py-4 bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold rounded-xl transition-all"
                >
                  Batalkan
                </button>
                <button 
                  onClick={() => handleSubmit(undefined, true)}
                  className="py-4 bg-brand hover:bg-brand-dark text-white font-bold rounded-xl shadow-lg shadow-brand/20 transition-all active:scale-95"
                >
                  Terbitkan (Talangan)
                </button>
              </div>
